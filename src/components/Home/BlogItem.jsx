...
const BlogItem = ({ data }) => {
  return (
    <div className="BlogItem max-w-[395px]  cursor-pointer group relative rounded-[20px] overflow-hidden min-h-[450px] md:max-h-[550px]   before:content-[''] before:w-full before:h-full before:absolute before:bg-red-500 before:top-0 before:left-0 before:-z-10 before:opacity-5">
