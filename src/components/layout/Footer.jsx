    ...
    >
      <div className="container relative z-20">
          ...
          <div className="left-area w-full md:w-2/4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="useful-links">
                ...
                >
                  {pathName === "/ar" ? " روابط مفيدة" : "USEFUL LINKS "}
                </h4>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                  <input
                    ...
                    value={pathName === "/ar" ? "اشترك" : "Subscribe"}
                  />
                </div>
              </form>
        ...
        <div className="bottom-footer w-full flex flex-col justify-between md:flex-row pt-10 md:pt-36 items-center">
          ...
          <div
            className={`payments flex flex-col-reverse md:flex-row gap-3 items-center justify-end`}
          >
