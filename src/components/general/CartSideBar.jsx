...
const CartSideBar = ({ isOpen, onClose }) => {
  return (
    <div
      className={`fixed inset-0 z-[999] transition-opacity duration-500 ${isOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}
              ...
              <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                  <div className="flex items-start justify-between">
                    <h2 className="text-lg font-medium text-gray-900 GeneralSans">Shopping cart</h2>
                          ...
                          <div className="ml-4 flex flex-1 flex-col">
                            <div>
                              <div className="flex justify-between text-base font-medium text-gray-900">
                                ...
                                <p className="ml-4 sale-price text-[#FC4242] text-lg font-semibold">$90.00</p>
                              </div>
                              <p className="mt-1 text-base md:text-lg font-medium">Salmon</p>
                            </div>
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  ...
                  <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                    <p>
                      or {" "}
                      <button type="button" className="font-medium text-[#FC4242]">
                        Continue Shopping
