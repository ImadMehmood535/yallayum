      ...
      <div className="py-12">
        <div className="container flex flex-col gap-8 ">
          <p className="font-medium">
            ...
            use of YallaYum’s Website.
          </p>
          <p>
            Welcome to yallayum.ae. The website is operated by YallaYum. If you
            ...
            which together with our privacy policy govern companies’
          ...
          <p>
            Promotions or offers listed on website – Some offers may have
            limited time to expired so make sure to check the offers expiry date
          </p>
